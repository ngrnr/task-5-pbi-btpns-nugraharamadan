...
import (
	...
	userRes "github.com/ngrnr/task-5-pbi-btpns-nugraharamadan/app/user"
...
func (h *userController) Login(c *gin.Context) {
	...
	response := helpers.ApiResponse(http.StatusOK, "success", formatter, "User Logged In Succesfully")
